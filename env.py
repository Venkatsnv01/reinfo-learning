...
class ContinuousMazeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if collided:
            ...
            new_distance = np.linalg.norm(new_pos - self.goal_pos)
            
            # Reward for moving closer to goal, penalty for moving away
            distance_reward = current_distance - new_distance
